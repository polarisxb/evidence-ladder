...
| B | 0.000 | 0.000 | 0.000 | 1.000 | 1.000 | 1.000 | PENDING | 8/8 (1.000) |
...
| A_prime | 1.000 | 0.500 | 0.000 | 0.000 | 1.000 | 0.000 | 1.000 | 0.000 | 1.000 | 3313.125 |
| B | 0.500 | 0.000 | 0.500 | 0.500 | 0.000 | 0.500 | 1.000 | 0.000 | 0.000 | 0.000 |
...
|---|---:|---:|---:|---:|
| Shared initial target | 8 | 8 | 8 | 25798 |
| Shared initial judge | 8 | 8 | 8 | 37873 |
| A incremental | 0 | 0 | 0 | 0 |
| A′ incremental | 8 | 8 | 8 | 26505 |
| B incremental | 8 | 0 | 8 | 0 |
| Total | 32 | 24 | 32 | 90176 |

B's 8 incremental calls split into 0 target retests and 0 judge calls.

## B strong-evidence standalone rate

- Estimate: 0.500 (4/8).
- Wilson 95% interval: [0.215, 0.785].
- Jeffreys 95% interval: [0.199, 0.801].
- Case-clustered bootstrap 95% interval: [0.125, 0.875].
...
|---|---|---:|---:|
| B_minus_A_error_rate | empirical | -0.500 | [-0.875, -0.125] |
| B_minus_A_prime_error_rate | empirical | -0.500 | [-0.875, -0.125] |
...
| B_minus_A_final_reported_asr | empirical | -0.500 | [-0.875, -0.125] |
| B_minus_A_strong_evidence_asr | definitional (baseline capped by construction) | 0.500 | [0.125, 0.875] |
| B_minus_A_prime_strong_evidence_asr | definitional (baseline capped by construction) | 0.500 | [0.125, 0.875] |
...
| judge-gpt-5.5_verifier-gpt-5.4 | B | 0.500 | 0.000 | 0.500 | 0.500 | 0.000 | 0.500 |
